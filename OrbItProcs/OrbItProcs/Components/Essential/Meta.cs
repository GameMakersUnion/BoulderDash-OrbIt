    ...
    public class Meta : Component
    {
        ...
        public override void Draw()
        {
            ...
            if (parent.IsPlayer)
            {
                ...
                room.camera.Draw(B, parent.body.pos, Color.Crimson, parent.body.scale * 1.7f, lightRotation + GMath.PIbyTwo, Layers.Under2);
                room.camera.Draw(X, parent.body.pos, Color.CornflowerBlue, parent.body.scale * 1.7f, lightRotation + GMath.PI, Layers.Under2);
                room.camera.Draw(Y, parent.body.pos, Color.Gold, parent.body.scale * 1.7f, lightRotation + GMath.PI + GMath.PIbyTwo, Layers.Under2);
